...
################################################################################
## Form generated from reading UI file 'Evento_aceptar_rechazar.ui'
##
...
"}")
        ...
        self.boton_CancelarEvento = QPushButton(self.frame)
        self.boton_CancelarEvento.setObjectName(u"boton_CancelarEvento")
        self.boton_CancelarEvento.setMinimumSize(QSize(120, 0))
        self.boton_CancelarEvento.setMaximumSize(QSize(120, 50))
...
"")
        ...
        self.verticalLayout_3.addWidget(self.boton_CancelarEvento)

        self.Boton_rechazarCancelacion = QPushButton(self.frame)
        self.Boton_rechazarCancelacion.setObjectName(u"Boton_rechazarCancelacion")
        self.Boton_rechazarCancelacion.setMinimumSize(QSize(120, 50))
        self.Boton_rechazarCancelacion.setMaximumSize(QSize(120, 16777215))
        self.Boton_rechazarCancelacion.setStyleSheet(u"/* Estilo para QPushButton */\n"
".QPushButton {\n"
"    background-color: #c57007; /* Color de fondo */\n"
"    color: white; /* Color de texto */\n"
"    border: none; /* Sin borde */\n"
...
"")
        ...
        self.verticalLayout_3.addWidget(self.Boton_rechazarCancelacion)
        ...
        self.verticalLayout_4.addWidget(self.frame_cancelacionEvento)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Boton_rechazarCancelacion.setText(QCoreApplication.translate("MainWindow", u"Rechazar", None))
    # retranslateUi
